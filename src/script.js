...
// pole lights materials
const poleLightMaterial = new THREE.MeshBasicMaterial({
    color: 0xffc596
});

// portal lights materials
debugObject.portalColorStart = '#ab5dd5';
...
const portalLightMaterial = new THREE.ShaderMaterial({
    uniforms: {
        uTime: {value: 0},
        uColorStart: {value: new THREE.Color(0xab5dd5)},
...
firefliesGeometry.setAttribute(
    'aScale', new THREE.BufferAttribute(
        scaleArray, 1
    )
);
